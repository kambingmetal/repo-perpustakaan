<x-layout.main pageTitle="Fasilitas">
        ...
        <div class="auto-container">
            <div class="content-box">
                ...
                <ul class="bread-crumb">
                    <li>Informasi fasilitas yang kami sediakan</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ $item->name }}</h3>
                                <p>{{ $item->description ?: 'Deskripsi fasilitas belum tersedia.' }}</p>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="col-12">
                        <div class="text-center py-5">
                            ...
                            <h3 class="mb-3">Belum Ada Fasilitas</h3>
                            <p class="text-muted">Fasilitas sedang dalam proses pengembangan dan akan segera tersedia.</p>
                        </div>
                    </div>
                @endforelse
            </div>
