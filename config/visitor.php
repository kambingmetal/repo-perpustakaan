...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Unique Visit Configuration
    |--------------------------------------------------------------------------
    |
    | Configuration for unique visit tracking based on IP, device, platform, and browser
    |
    */
    
    // Time in hours to consider a visitor as unique (default 24 hours)
    'unique_visit_duration' => 24,
